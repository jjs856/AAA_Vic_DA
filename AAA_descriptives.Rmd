...
victoria_new_two <- read_csv("~/INTERACT/veritas/health_2vic_main_bfd440e.csv") # victoria health wave two survey
victoria_eligibility_two <- read_csv("~/INTERACT/veritas/eligibility_2vic_main_bfd440e.csv")# victoria eligibility wave two survey
...
```{r}
SD_vic_one <- read_csv("victoria_01_top_1min") # read in SD w1 participants
sd_vic_two <- read_csv("victoria_02_top_1min") # read in SD w2 participants 
