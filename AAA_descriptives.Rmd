...
```{r Reading in Data}
getwd()
setwd("C:/Users/jslan/OneDrive/Documents/INTERACT/AAA_Veritas_w2")

#add wave one data
victoria_new <- read_csv("health_1vic_main_bfd440e.csv") #victoria health survey
victoria_eligibility <- read_csv("eligibility_1vic_main_bfd440e.csv") #victoria eligibility survey
...
victoria_new_two <- read_csv("health_1vic_main_bfd440e.csv") # victoria health wave two survey
victoria_eligibility_two <- read_csv("eligibility_2vic_main_bfd440e.csv") # victoria eligibility wave two survey
...
## If this doesn't work try bindrows()
# May not line up (some difference in dfs)
victoria_merged <- bind_rows(victoria_eligibility, victoria_new, victoria_new_two, victoria_eligibility_two, by = "interact_id") #merging eligibility and health survey together 
